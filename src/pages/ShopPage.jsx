...
function Shop() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--text)' }}>
      {/* Sticky Header with Dynamic Scroll Physics */}
      <motion.header 
        animate={{
        ...
        <div style={{ maxWidth: 700, margin: '0 auto', padding: '0 16px', height: 60, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            >
              ...
              <motion.span key={totalItems} initial={{ scale: 1.3 }} animate={{ scale: 1 }}>
      ...
      <main style={{ maxWidth: 700, margin: '0 auto', padding: '24px 16px 48px' }}>
        ...
        {/* Dynamic Sliding Pill Category Bar */}
        <div 
          style={{ 
            display: 'flex', 
            gap: 8, 
            ...
            >
              {tab === cat && (
                <motion.div
                  ...
                  style={{ position: 'absolute', inset: 0, background: '#ffd700', borderRadius: 100, zIndex: -1 }}
        ...
        {/* Product Grid with Motion Reveal */}
        {loading ? (
